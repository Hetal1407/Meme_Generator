...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ChromeFieldsComponent, [{
        type: Component,
        args: [{
...
ChromeComponent.ɵcmp = ɵngcc0.ɵɵdefineComponent({ type: ChromeComponent, selectors: [["color-chrome"]], inputs: { disableAlpha: "disableAlpha" }, features: [ɵngcc0.ɵɵInheritDefinitionFeature], decls: 14, vars: 16, consts: [[1, "saturation"], [3, "hsl", "hsv", "circle", "onChange"], [1, "chrome-body"], [1, "chrome-controls"], [1, "chrome-color"], [1, "chrome-swatch"], [1, "chrome-active"], [1, "chrome-toggles"], [1, "chrome-hue"], [3, "radius", "hsl", "pointer", "onChange"], ["class", "chrome-alpha", 4, "ngIf"], [3, "rgb", "hsl", "hex", "disableAlpha", "onChange"], [1, "chrome-alpha"], [3, "radius", "rgb", "hsl", "pointer", "onChange"]], template: function ChromeComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        ɵngcc0.ɵɵadvance(5);
        ɵngcc0.ɵɵstyleProp("background", ctx.activeBackground);
        ɵngcc0.ɵɵadvance(4);
...
ColorChromeModule.ɵfac = function ColorChromeModule_Factory(t) { return new (t || ColorChromeModule)(); };
ColorChromeModule.ɵmod = ɵngcc0.ɵɵdefineNgModule({ type: ColorChromeModule });
ColorChromeModule.ɵinj = ɵngcc0.ɵɵdefineInjector({ imports: [[
            CommonModule,
            AlphaModule,
            CheckboardModule,
            EditableInputModule,
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(ColorChromeModule, { declarations: function () { return [ChromeComponent, ChromeFieldsComponent]; }, imports: function () { return [CommonModule,
        AlphaModule,
        CheckboardModule,
        EditableInputModule,
        HueModule,
        SaturationModule]; }, exports: function () { return [ChromeComponent, ChromeFieldsComponent]; } }); })();
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ColorChromeModule, [{
        type: NgModule,
        args: [{
